            ...
            <div class="w-full mx-auto sm:px-6 lg:px-8">
                <div v-if="userRole === 'superuser'">
                    <div class="mb-4 flex items-center">
                        ...
                        <h1 class="text-2xl font-bold ml-2">{{ $page.props.app.setting.name }}</h1>
                    </div>
                    <div class="grid gap-2 md:grid-cols-12">
                        <div class="md:col-span-9 col-span-12 bg-white dark:bg-slate-800 p-4 shadow-md rounded-md">
                            <h2 class="text-xl font-semibold capitalize text-start mb-4">Grafik Pendaftaran
                                Karyawan</h2>
                        ...
                        <div class="md:col-span-3 col-span-12 grid sm:grid-cols-2 md:grid-cols-1 gap-2">
                            <div class="bg-white dark:bg-slate-800 shadow-md rounded-md p-4 flex flex-col items-center">
                                <h2 class="text-lg font-semibold text-center pb-2">Perbandingan Jenis Kelamin</h2>
                                <PieChart :data="pieCharts.genderDistribution"
                                          class="w-auto h-auto max-w-[85%] max-h-[85%] mx-auto aspect-square"/>
                            </div>
                            <div class="bg-white dark:bg-slate-800 shadow-md rounded-md p-4 flex flex-col items-center">
                                <h2 class="text-lg font-semibold text-center pb-2">Perbandingan Status</h2>
                                <PieChart :data="pieCharts.statusDistribution"
                                          class="w-auto h-auto max-w-[85%] max-h-[85%] mx-auto aspect-square"/>
                            </div>
                        </div>
                    </div>
                    <Employee
                            :employeeTable="props.employeeTable"
