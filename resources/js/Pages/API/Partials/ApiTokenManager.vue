    ...
    <div>
        ...
        <FormSection @submitted="createApiToken">
            ...
            <template #form>
                ...
                <div class="col-span-6 sm:col-span-4">
                    <InputLabel :value="lang().label.token_name" for="name"/>
                    <TextInput id="name" v-model="createApiTokenForm.name" :error="createApiTokenForm.errors.name"
                               :placeholder="lang().placeholder.token_name"
                               autofocus
                ...
                <div v-if="availablePermissions.length > 0" class="col-span-6">
                    <InputLabel :value="lang().label.permissions" for="permissions"/>
        ...
        <DialogModal :show="managingPermissionsFor != null" @close="managingPermissionsFor = null">
            ...
            <template #footer>
                ...
                <PrimaryButton :class="{ 'opacity-25': updateApiTokenForm.processing }"
                               :disabled="updateApiTokenForm.processing"
                               class="ml-3" @click="updateApiToken">
        ...
        <ConfirmationModal :show="apiTokenBeingDeleted != null" @close="apiTokenBeingDeleted = null">
            ...
            <template #footer>
                ...
                <DangerButton :class="{ 'opacity-25': deleteApiTokenForm.processing }"
                              :disabled="deleteApiTokenForm.processing"
                              class="ml-3" @click="deleteApiToken">
