        ...
        <template #content>
            ...
            <DialogModal :show="confirmingUserDeletion" @close="closeModal">
                ...
                <template #content>
                    ...
                    <div class="mt-4">
                        <TextInput ref="passwordInput" v-model="form.password" :error="form.errors.password"
                                   autocomplete="current-password"
                                   class="mt-1 block w-full" placeholder="Password" type="password"
                ...
                <template #footer>
                    ...
                    <DangerButton :class="{ 'opacity-25': form.processing }" :disabled="form.processing" class="ml-3"
                                  @click="deleteUser">
