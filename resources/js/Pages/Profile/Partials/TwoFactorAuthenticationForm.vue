            ...
            <div v-if="twoFactorEnabled">
                <div v-if="qrCode">
                    ...
                    <div v-if="confirming" class="mt-4">
                        ...
                        <TextInput id="code" v-model="confirmationForm.code" :error="confirmationForm.errors.code"
                                   autocomplete="one-time-code"
                                   autofocus class="block mt-1 w-1/2" inputmode="numeric" name="code"
            ...
            <div class="mt-5">
                ...
                <div v-else>
                    <ConfirmsPassword @confirmed="confirmTwoFactorAuthentication">
                        <PrimaryButton v-if="confirming" :class="{ 'opacity-25': enabling }" :disabled="enabling"
                                       class="mr-3"
                                       type="button">
