                    ...
                    <Table>
                        ...
                        <template #table-head>
                            <tr>
                                ...
                                <th class="p-4 cursor-pointer" v-on:click="order('guard_name')">
                        ...
                        <template #table-body>
                            ...
                            >
                                ...
                                <td
                                        class="whitespace-nowrap px-4 py-1 text-center"
                                >
                                    {{ ++index }}
                                </td>
                                <td class="whitespace-nowrap px-4 py-1">
                                ...
                                <td
                                        class="whitespace-nowrap flex justify-end px-4 py-1"
                                >
                                    <div
